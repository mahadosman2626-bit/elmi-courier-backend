...
const { toggleStatus, earnings, withdraw, updateProfile, uploadDocuments, updateProfilePhoto } = require('../controllers/driverController');
...
router.patch('/photo',     requireAuth, requireRole('DRIVER'), updateProfilePhoto);
